...
//  Letters
//
//  Created by Thomas Frow on 26/09/2013.
//  Copyright (c) 2013 Thomas Frow. All rights reserved.
//
...
int main(int argc, char** argv)
{
   // Allow cmd line arguments to be passed to the glut
    ...
    glutCreateWindow("Letters Example");
